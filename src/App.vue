<template>
  <div id="wrapper">
          ...
          <div class="navbar-item">
            <form method="get" action="/search">
              <div class="field has-addons">
                <div class="control">
                  <input type="text" class="input" placeholder="상품명을 검색하세요" name="query">
                </div>
          ...
          <div class="navbar-item">
            <div class="buttons">
              <template v-if="$store.state.isAuthenticated">
                <router-link to="/my-account" class="button is-light">회원정보</router-link>
              </template>
    ...
    <footer class="footer">
      <p class="has-text-centered">Copyright (c) 2021 HugeK</p>
    </footer>
  </div>
</template>
